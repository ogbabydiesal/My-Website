...
const Navbar= () =>{
  ...
  <div className='nav'>
    <List>
      <Link onMouseEnter={() => setHoverWelcome(true)}
    ...
    <List>
      <a onMouseEnter={() => setHoverRoom(true)}
    ...
    <List>
      <Link onMouseEnter={() => setHoverSoftware(true)}
      ...
      <Software>
        <List>
          <Link onMouseEnter={() => setHoverImsys(true)}
        ...
        <List>
          <Link onMouseEnter={() => setHoverLearner(true)}
        ...
        <List>
          <Link onMouseEnter={() => setHoverLayer(true)}
    ...
    <List>
        <a onMouseEnter={() => setHoverGithub(true)}
    ...
    <List>
      <a onMouseEnter={() => setHoverInstagram(true)}
    ...
    <List>
      <a onMouseEnter={() => setHoverTwitter(true)}
